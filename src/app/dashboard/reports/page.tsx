      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-400 text-sm">Deep dive into your financial health.</p>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative flex items-center gap-4">
                  <div className={`p-3 rounded-xl ${isActive ? 'bg-indigo-500/20 text-indigo-400' : 'bg-slate-800 text-slate-400 group-hover:text-slate-300'}`}>
                    <Icon className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className={`font-semibold ${isActive ? 'text-white' : 'text-slate-300 group-hover:text-white'}`}>
                      {report.name}
                    </h3>
        ...
        >
          ...
          {activeReport === 'income-expense' && (
            <IncomeExpenseReport startDate={startDate} endDate={endDate} />
          )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/20 rounded-lg transition-colors text-sm font-medium">
            ...
            <p className="text-xs text-slate-500 mt-4">
              * Exports include all data currently visible in the selected report timeframe.
            </p>
          </div>
