    ...
    if (!reportData) {
        return (
            <div className="flex flex-col items-center justify-center py-20 text-slate-500">
                ...
                <p className="text-sm">
                    Please select a start and end date above.
                </p>
            </div>
        );
    }
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="p-5 rounded-2xl bg-slate-950/50 border border-slate-800 flex flex-col justify-between">
                    <div className="flex items-center gap-3 mb-3">
                        <div
                            className={`p-2 rounded-lg ${summary.netIncome >= 0 ? "bg-indigo-500/10 border-indigo-500/20" : "bg-amber-500/10 border-amber-500/20"}`}
                        >
                            <Wallet
                                className={`w-5 h-5 ${summary.netIncome >= 0 ? "text-indigo-400" : "text-amber-400"}`}
                            />
                        </div>
                        <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">
                            Net Flow
                    ...
                    <p
                        className={`text-2xl font-bold ${summary.netIncome >= 0 ? "text-indigo-400" : "text-amber-400"}`}
                    >
                            ...
                            <tbody className="divide-y divide-slate-800">
                                {monthlyTrends.map((trend: any) => (
                                    ...
                                    >
                                        ...
                                        <td
                                            className={`px-6 py-4 font-semibold ${trend.net >= 0 ? "text-white" : "text-rose-200"}`}
                                        >
